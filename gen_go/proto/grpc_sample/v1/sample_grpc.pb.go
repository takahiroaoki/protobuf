...
const (
	SampleService_GetUserInfo_FullMethodName = "/grpc_sample.v1.SampleService/GetUserInfo"
	SampleService_CreateUser_FullMethodName  = "/grpc_sample.v1.SampleService/CreateUser"
)
...
func (c *sampleServiceClient) GetUserInfo(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SampleService_GetUserInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SampleService_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SampleService_GetUserInfo_FullMethodName,
	}
...
var SampleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_sample.v1.SampleService",
	...
	Metadata: "grpc_sample/v1/sample.proto",
}
